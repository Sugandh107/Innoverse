	...
	return (
		<section
			...
			<div className='text-center mt-16 relative z-10'>
				...
				<Link
					to='/'
					className='absolute top-[40px] left-1/2 -translate-x-1/2 flex flex-col sm:flex-row items-center gap-1 sm:gap-2 text-xs sm:text-base text-cyan-400 hover:text-purple-400 transition-all duration-300 z-50'>
					<div className='flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-cyan-500 hover:bg-cyan-600 shadow-md sm:shadow-lg'>
						<svg
					...
					<span className='text-white font-medium text-[10px] sm:text-base'>
						Back to Home
					</span>
				</Link>
			</div>
