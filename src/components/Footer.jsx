...
const Footer = () => {
    ...
    const NavLinkItem = ({ link }) => {
        const commonClasses = "hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 text-sm block";
            ...
            <div className="mx-auto w-full max-w-screen-xl p-6 lg:p-10">
                <div className="md:flex md:justify-between mb-8">
                    <div className="mb-8 md:mb-0">
                        <a href="https://git.edu/" target="_blank" rel="noopener noreferrer" className="flex items-center">
                            <img src="/logo.png" className="h-8 me-1 sm:me-3 rounded-md" alt="KLS Logo" />
                            ...
                            <img src="3.png" className="h-8 ms-1 sm:ms-3 rounded-md" alt="GIT Logo" />
                        </a>
                        ...
                        <div className="flex flex-col gap-2 mt-2 text-sm text-gray-500 max-w-sm">
                            <p className='flex gap-2'>
                                <span><Phone className="w-4 h-4" /></span> +91-831-2405500
                            </p>
                            <p className='flex gap-2'>
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-24 sm:grid-cols-2">
                        <div>
                            <h2 className="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">Navigation</h2>
                        ...
                        <div className='col-span-1'> 
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium space-y-2">
                                <li>
                                    <a href="https://www.linkedin.com/company/klsgitbelagavi/" target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 block hover:underline text-sm">Linked-In</a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/KLSGITBelagavi" target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 block hover:underline text-sm">Facebook</a>
                                </li>
                                <li>
                                    <a href="https://x.com/klsgitbelagavi" target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 block hover:underline text-sm">X (Twitter)</a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/klsgitbelagavi/" target="_blank" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 block hover:underline text-sm">Instagram</a>
                                </li>
                            </ul>
                        </div>
