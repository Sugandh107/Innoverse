...
const FAQSection = ({
  ...
  faqs = [
    ...
    // },
    {
      ...
      answer:
        "Teams can have 3 members, or you can participate solo. We encourage diverse teams for stronger collaboration!",
    },
    {
      question: "Are cross-college teams allowed?",
      answer:
        "No! Innoverse does not allow cross-college teams — build a diverse team and bring your ideas to life!",
    },
    {
